...
var SalesBillingvatComponent = /** @class */ (function () {
    /**
     * Constructor
     *
     * @param fb
     ...
     * @param modalService
     */
    function SalesBillingvatComponent(fb, _purchaseService, _purchaseDetailsService, _accountTransValues, _customerService, date, modalService, fileService) {
        this.fb = fb;
    ...
    SalesBillingvatComponent.prototype.ngOnInit = function () {
    ...
    SalesBillingvatComponent.prototype.LoadCustomers = function () {
        var _this = this;
        debugger;
    ...
    SalesBillingvatComponent.prototype.voucherDateValidator = function (control) {
        var today = new Date;
    ...
    SalesBillingvatComponent.prototype.viewFile = function (fileUrl, template) {
     ...
     */
    SalesBillingvatComponent.prototype.exportTableToExcel = function (tableID, filename) {
    ...
    SalesBillingvatComponent.prototype.loadSalesBillingList = function () {
        var _this = this;
        this.indLoading = true;
    ...
    SalesBillingvatComponent.prototype.addSalesBilling = function () {
    ...
    SalesBillingvatComponent.prototype.getSalesBilling = function (Id) {
        this.indLoading = true;
     ...
     * @param Id
     */
    SalesBillingvatComponent.prototype.editSalesBilling = function (Id) {
        var _this = this;
        this.reset();
    ...
    SalesBillingvatComponent.prototype.deleteSalesBilling = function (Id) {
        var _this = this;
    ...
    SalesBillingvatComponent.prototype.initSalesOrderDetails = function () {
    ...
    SalesBillingvatComponent.prototype.initJournalDetail = function () {
        return this.fb.group({
    ...
    SalesBillingvatComponent.prototype.addSalesBillingitems = function () {
    ...
    //remove the rows//
    SalesBillingvatComponent.prototype.removeSalesBillingitems = function (i) {
    ...
    SalesBillingvatComponent.prototype.calculateAmount = function () {
    ...
    SalesBillingvatComponent.prototype.calculateNetAmount = function (salesBillingForm) {
    ...
    SalesBillingvatComponent.prototype.calculateVATAmount = function (salesBillingForm) {
        this.getDiscountPercent(salesBillingForm);
        var totalAmt = this.calculateAmount();
        var calcVatAmt = salesBillingForm.VATAmount.setValue(((totalAmt - (salesBillingForm.Discount.value)) * 0.13).toFixed(2));
        return calcVatAmt;
    };
    SalesBillingvatComponent.prototype.calculateGndAmount = function (salesBillingForm) {
        this.getDiscountPercent(salesBillingForm);
        var totalAmt = this.calculateAmount();
    ...
    SalesBillingvatComponent.prototype.calculatePercentDiscountAmount = function (salesBillingForm) {
        var IsDiscountPercentage = this.salesBillingForm.controls['IsDiscountPercentage'];
    ...
    SalesBillingvatComponent.prototype.getDiscountPercent = function (salesBillingForm) {
        var IsDiscountPercentage = this.salesBillingForm.controls['IsDiscountPercentage'];
        var Discount = this.salesBillingForm.controls['Discount'];
        var PercentAmount = this.salesBillingForm.controls['PercentAmount'];
    ...
    SalesBillingvatComponent.prototype.validateAllFields = function (formGroup) {
        var _this = this;
    ...
    SalesBillingvatComponent.prototype.openModal2 = function (template) {
        this.modalRef2 = this.modalService.show(template, { class: 'modal-sm' });
    };
    SalesBillingvatComponent.prototype.calcDiscountTotal = function (SalesBilling) {
        var Discount = 0;
    ...
    SalesBillingvatComponent.prototype.calcNetAmount = function (SalesBilling) {
        var NetAmount = 0;
        for (var i = 0; i < SalesBilling.length; i++) {
    ...
    SalesBillingvatComponent.prototype.calcVATAmount = function (SalesBilling) {
        var VATAmount = 0;
        for (var i = 0; i < SalesBilling.length; i++) {
    ...
    SalesBillingvatComponent.prototype.calcGrandAmount = function (SalesBilling) {
    ...
    SalesBillingvatComponent.prototype.calcAmount = function (SalesBilling) {
        var netAmount = this.calcNetAmount(SalesBilling);
    ...
    SalesBillingvatComponent.prototype.calcaAmount = function (netAmount) {
        var GrandAmt = netAmount;
        return GrandAmt;
    };
    SalesBillingvatComponent.prototype.calcaNetAmount = function (netAmt, discountAmt) {
        var NetAmount = netAmt - discountAmt;
        return NetAmount;
    };
    // Calculate sale billing Grand Amount
    SalesBillingvatComponent.prototype.calculateGrandAmount = function (vatAmount, netAmount, discountAmt) {
        var GrandAmt = vatAmount + (netAmount - discountAmt);
        return GrandAmt;
    };
    SalesBillingvatComponent.prototype.onSubmit = function (fileUpload) {
        var _this = this;
        this.msg = "";
    ...
    SalesBillingvatComponent.prototype.confirm = function () {
        this.modalRef2.hide();
        this.formSubmitAttempt = false;
    };
    SalesBillingvatComponent.prototype.reset = function () {
    ...
    SalesBillingvatComponent.prototype.SetControlsState = function (isEnable) {
     ...
     */
    SalesBillingvatComponent.prototype.filterPurchasesByDate = function () {
        var _this = this;
        this.indLoading = true;
        this._purchaseService.get(global_1.Global.BASE_SALE_BILLING_ENDPOINT + '?fromDate=' + this.date.transform(this.fromDate, 'yyyy-MM-dd') + '&toDate=' + this.date.transform(this.toDate, 'yyyy-MM-dd') + '&TransactionTypeId=' + 3)
            .subscribe(function (SalesBilling) {
    ...
    SalesBillingvatComponent.prototype.onFilterDateSelect = function (selectedDate) {
        var currentYearStartDate = new Date(this.currentYear.StartDate);
        var currentYearEndDate = new Date(this.currentYear.EndDate);
    ...
    ], SalesBillingvatComponent.prototype, "TemplateRef", void 0);
    __decorate([
        core_1.ViewChild('templateNested')
    ], SalesBillingvatComponent.prototype, "TemplateRef2", void 0);
    __decorate([
        core_1.ViewChild('fileInput')
    ], SalesBillingvatComponent.prototype, "fileInput", void 0);
    SalesBillingvatComponent = __decorate([
        core_1.Component({
            templateUrl: './sales-billingvat.component.html',
            styleUrls: ['./sales-billingvat.component.css']
        })
    ], SalesBillingvatComponent);
    return SalesBillingvatComponent;
}());
exports.SalesBillingvatComponent = SalesBillingvatComponent;
