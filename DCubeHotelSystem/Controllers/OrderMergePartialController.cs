...
{
    [UserRoleAuthorize]
    public class OrderMergePartialController : BaseAPIController
    {
        ...
        public OrderMergePartialController()
        {
          ...
          MoveScreenMultiOrderItemRequest objMoveScreenMultiOrderItemRequest)
        {
            ...
            orderItemResponse = TicketBusiness.OrderMergePartial(this.AccountTypeRepository, this.AccountTransactionTypeRepository, this.AccountRepository, this.TicketRepository, this.OrderRepository, this.AccountTranastionRepository, this.AccountTransactionValueRepository, this.TransactionDocumentRepository, this.exceptionRepository, objMoveScreenMultiOrderItemRequest);
